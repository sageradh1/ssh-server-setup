...
# c.JupyterApp.config_file = '/config/jupyter_notebook_config.py'
...
c.NotebookApp.password = 'argon2:$argon2id$v=19$m=10240,t=10,p=8$VfuUfubsdP+flLmOvIusAw$zMd4oJDjell4Pwx8aT+RTg'
