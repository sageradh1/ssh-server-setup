#!/bin/bash
_remote="nitenl@124.41.198.206"
_user="nitenl"
_user_folder="/home/asmi/setup/ssh-server-setup/containers/tjg-2-niten"
...
ssh -i $_user -T $_remote <<'EOL'
    echo "Normal user"
    mkdir -p /home/nitenl/setup/ssh-server-setup/containers
	echo "Bye"
EOL
